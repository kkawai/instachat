...
public final class LocalFileUtils {
    ...
    public static File downloadFile(final String urlString, final File targetFile, final ProgressListener progressListener, final IhProgressiveProgressDialog progressDialog) throws Exception {
    ...
    public static File getPermanentFile(final String key, final ProgressListener progressListener, final IhProgressiveProgressDialog progressDialog) throws Exception {
        ...
        return LocalFileUtils.downloadFile("http://ih.usr.s3.amazonaws.com/" + key, targetPath, progressListener, progressDialog);
    }
     ...
     */
    public static File getPermanentFile(final String key) throws Exception {
        ...
        permPath.mkdirs();
        final File targetPath = new File(permPath.getPath() + "/" + key);
        return LocalFileUtils.downloadFile("http://ih.usr.s3.amazonaws.com/" + key, targetPath, null, null);
    }
