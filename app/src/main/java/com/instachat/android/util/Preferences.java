...
public final class Preferences {
   ...
   public void clearUser(Editor editor) {
      editor.remove(PREFERENCE_USER).remove(PREFERENCE_USER_ID).remove(PREFERENCE_USER_NAME).remove(PREFERENCE_EMAIL).remove(PREFERENCE_IS_LOGGED_IN).apply();
   }
   ...
   public void saveUser(final User user) {
      ...
      if (user == null) {
         ...
         editor.putBoolean(PREFERENCE_IS_LOGGED_IN, true).putString(PREFERENCE_USER, user.toJSON().toString()).putInt(PREFERENCE_USER_ID, user.getId()).putString(PREFERENCE_USER_NAME, user.getUsername()).putString(PREFERENCE_EMAIL, user.getEmail());
      }
      editor.commit();
   }
   ...
   public void saveAccessToken(final String accessToken) {
      ...
      if (accessToken == null) {
         ...
         MLog.i(Preferences.class.getSimpleName(), "Prefences.saveAccessToken() removed access token because it's null..");
      } else {
