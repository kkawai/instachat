...
import com.instachat.android.UsersInGroupListener;
...
public class ChatSummariesRecyclerAdapter extends RecyclerView.Adapter implements StickyHeaderHandler {
   ...
   public ChatSummariesRecyclerAdapter(@NonNull ChatsItemClickedListener chatsItemClickedListener, @NonNull ActivityState activityState) {
