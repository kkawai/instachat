...
public abstract class DomainObject implements Serializable {
     ...
     * means
     *
     * @param inObject       - object to be copied from, can be any java bean or JSONObject
     * @param exceptionField - name of field to be ignored, typically "id"
     * @param getSuperclass  - obtain fields of superclass
