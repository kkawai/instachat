...
public final class ZoomableImageView extends MyNetworkImageView {
    ...
    public void setInitialScale(final float f) {
        mInitialScale = f;
    }
    ...
    // Single tap listener
    private ZoomImageListener mZoomableImageListener;
    ...
    public void setZoomableImageListener(ZoomImageListener listener) {
        this.mZoomableImageListener = listener;
    }
    ...
    private void setBaseMatrix(Bitmap bitmap, Matrix matrix) {
        ...
        float widthScale = Math
                .min(viewWidth / (float) bitmap.getWidth(), mInitialScale);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBitmap != null && !mBitmap.isRecycled()) {
            ...
            // canvas.rotate(rotateAngel, getWidth()/2, getHeight()/2);
            ...
            if (mZoomableImageListener != null)
                mZoomableImageListener.onRequestDisallowInterceptTouchEvent(isZoomed());
        }
    }
    ...
    private class MyGestureListener extends
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            if (mZoomableImageListener != null) {
                mZoomableImageListener.onImageTouched();
                return false;
            }
        ...
        public boolean onDoubleTap(MotionEvent e) {
            //AnalyticsHelper.logEvent(Events.USER_PHOTO_FULL_SCREEN_DOUBLE_TAP);
    ...
    public boolean isZoomed() {
        ...
        float defaultZoom = zoomDefault();
        return scale > defaultZoom;
    }
