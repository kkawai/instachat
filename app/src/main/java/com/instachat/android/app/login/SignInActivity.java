...
public class SignInActivity extends BaseActivity<ActivitySignInBinding, SignInViewModel> implements View.OnClickListener, View.OnFocusChangeListener, SignInNavigator {
   ...
   /*private void testPhoneVerify() {
      PhoneAuthProvider.getInstance().verifyPhoneNumber(
              "+16507035930",        // Phone number to verify
              ...
              new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                 ...
                 public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                     MLog.i(TAG,"phone onVerificationCompleted. phoneAuthCredential signInMethod: " + phoneAuthCredential.getSignInMethod()
                             + " provider: " + phoneAuthCredential.getProvider() + " smsCode: " + phoneAuthCredential.getSmsCode());
                 }

                 @Override
                 public void onVerificationFailed(FirebaseException e) {
                    MLog.e(TAG, "phone onVerificationFailed. FirebaseException: " + e);
                 }
   ...
   /*public void checkCode(View view) {
      EditText text = findViewById(R.id.smscode);
      CharSequence code = text.getText();
