...
public class VerifyPhoneViewModel extends BaseViewModel<VerifyPhoneNavigator> {

    //public ObservableArrayList<ItemViewModel> list = new ObservableArrayList<>();

    public VerifyPhoneViewModel(DataManager dataManager, SchedulerProvider schedulerProvider) {
