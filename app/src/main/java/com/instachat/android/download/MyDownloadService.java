...
package com.instachat.android.download;
...
public class MyDownloadService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        MLog.d(TAG, "onStartCommand:" + intent + ":" + startId);
        ...
        if (ACTION_DOWNLOAD.equals(intent.getAction())) {
            ...
            // Mark task started
            MLog.d(TAG, ACTION_DOWNLOAD + ":" + downloadPath);
            taskStarted();
            ...
            mStorage.child(downloadPath).getStream()
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            MLog.w(TAG, "download:FAILURE", exception);
    ...
    private synchronized void changeNumberOfTasks(int delta) {
        MLog.d(TAG, "changeNumberOfTasks:" + mNumTasks + ":" + delta);
        mNumTasks += delta;
