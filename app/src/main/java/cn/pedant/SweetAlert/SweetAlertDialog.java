...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
    ...
    private void restore() {
        ...
        mConfirmButton.setBackgroundResource(R.drawable.sweet_arlert_blue_button_background);
        ...
        if (mDialogView != null) {
            ...
            switch (mAlertType) {
                ...
                case SUCCESS_TYPE:
                    ...
                    break;
                case WARNING_TYPE:
                    mConfirmButton.setBackgroundResource(R.drawable.sweet_alert_red_button_background);
